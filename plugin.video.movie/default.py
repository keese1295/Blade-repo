...
ADDON=xbmcaddon.Addon(id='plugin.video.movie')
...
def CATEGORIES():
    link = OPEN_URL('https://kodi2.000webhostapp.com/index.html/Wizard/wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=gold]MovieTime Wizard[/COLOR]","[COLOR=red]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
